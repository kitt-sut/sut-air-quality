...
โปรเจ็กต์นี้อ่านข้อมูลค่า PM 2.5 จาก Google Sheets แบบสาธารณะ โดยจะอ่านข้อมูล 10 แถวล่าสุดผ่าน URL `export?format=csv` 
แล้วค้นหาค่า PM 2.5 ล่าสุดมาแสดงผล โดยค่าเริ่มต้นจะตั้งให้อ่านจากคอลัมน์ที่ 5 (คอลัมน์ E) ซึ่งสามารถปรับเปลี่ยนตำแหน่งคอลัมน์นี้ได้ง่ายๆ 
ผ่านตัวแปร `PM25_COL_INDEX` ในไฟล์ `src/config/index.js` หากพบข้อผิดพลาดในการดึงข้อมูล ระบบจะแสดงแบนเนอร์แจ้งเตือนและพยายามโหลดข้อมูลใหม่โดยอัตโนมัติ
